...
class SubscribeSection extends Timber {
  ...
  public function __construct() {
    ...
    add_shortcode('subscribe_section', 'subscribe_section');
  }
  ...
  public function plugin_timber_locations() {
    ...
    array_push(
      Timber::$locations, 
      SUBSCRIBE_SECTION_PATH . 'views'
    );
  }
  public function plugin_text_domain_init() {
    load_plugin_textdomain('subscribe-section', false, SUBSCRIBE_SECTION_BASE. '/languages');
  }
  public function plugin_enqueue_assets() {
    wp_enqueue_style(
      'subscribe-section',
      SUBSCRIBE_SECTION_URL . 'public/css/subscribe-section.css'
    );
    wp_enqueue_style(
      'uikit',
